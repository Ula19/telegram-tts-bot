"""Rate limiting — ограничение частоты запросов на озвучку
...
# лимит — сколько запросов на озвучку в минуту
MAX_REQUESTS = 5
WINDOW_SECONDS = 60
...
class RateLimitMiddleware(BaseMiddleware):
    ...
    async def __call__(
        ...
        # rate limit применяется ко всем текстовым сообщениям, кроме команд
